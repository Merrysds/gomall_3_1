...
func (x *CreditCardInfo) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.CreditCardExpirationMouth, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *CreditCardInfo) fastWriteField4(buf []byte) (offset int) {
	if x.CreditCardExpirationMouth == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 4, x.GetCreditCardExpirationMouth())
	return offset
}
...
func (x *CreditCardInfo) sizeField4() (n int) {
	...
	n += fastpb.SizeInt32(4, x.GetCreditCardExpirationMouth())
	return n
}
