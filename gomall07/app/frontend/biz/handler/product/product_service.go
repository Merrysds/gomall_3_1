...
import (
	...
	product "github.com/cloudwego/gomall07/app/frontend/hertz_gen/frontend/product"
...
func GetProduct(ctx context.Context, c *app.RequestContext) {
	...
	c.HTML(consts.StatusOK, "product", utils.WarResponse(ctx, c, resp))
}
...
func SearchProducs(ctx context.Context, c *app.RequestContext) {
	...
	c.HTML(consts.StatusOK, "search", utils.WarResponse(ctx, c, resp))
}
