...
var file_auth_page_proto_rawDesc = []byte{
	...
	0x77, 0x6f, 0x72, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x32, 0xf9, 0x01, 0x0a, 0x0c,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x49, 0x0a, 0x05,
	...
	0x2f, 0x6c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x77, 0x65, 0x67, 0x6f, 0x2f,
	0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x30, 0x35, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x66, 0x72, 0x6f,
...
var file_auth_page_proto_depIdxs = []int32{
	0, // 0: frontend.auth.LoginService.login:input_type -> frontend.auth.LoginReq
	1, // 1: frontend.auth.LoginService.register:input_type -> frontend.auth.RegisterReq
	2, // 2: frontend.auth.LoginService.logout:input_type -> frontend.common.Empty
	2, // 3: frontend.auth.LoginService.login:output_type -> frontend.common.Empty
	2, // 4: frontend.auth.LoginService.register:output_type -> frontend.common.Empty
	2, // 5: frontend.auth.LoginService.logout:output_type -> frontend.common.Empty
